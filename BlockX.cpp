...
int main(int argc, char* argv[]) 
{
	...
	{
		SDL_ShowSimpleMessageBox( SDL_MESSAGEBOX_ERROR, "Error", "Error Loading game resources.\n", NULL);
	...
	sceneMngr.AddScreen( GameMainScreens::MENU_SCREEN, &mainMenuScreen );
	sceneMngr.AddScreen( GameMainScreens::GAME_SCREEN, &mainGameScreen);
